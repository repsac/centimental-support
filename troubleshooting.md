...
3. Centimental uses UUID-based union merge when two devices have different tunings offline — in normal operation no tuning should be lost, even during offline edits. If you have a genuinely missing tuning, please email us at [appstore@edcaspersen.com](mailto:appstore@edcaspersen.com) with your Apple ID email and we'll investigate.
